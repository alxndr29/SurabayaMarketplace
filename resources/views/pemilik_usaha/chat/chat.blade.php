...
<div class="row">
    <div class="col-3">
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item border-1" id="list-participant" data-id="{{$value->usersid}}">
                <div class="d-flex">
                    <div class="p-3">
    ...
    <div class="col-9">
        ...
        <div class="box box-primary direct-chat direct-chat-primary">
            <div class="box-header with-border">
                <h3 class="box-title" id="titleChat">Direct Chat</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">

                <div class="direct-chat-messages" id="isiChat">
        ...
        <!--/.direct-chat  https://codepen.io/anwar0x09/pen/zMRyBx references-->
    </div>
</div>
@endsection
@section('script')
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("body").on('click', '#list-participant', function(e) {
    ...
    $("#send").on('click', function() {
        // alert($("#message").val());
        $.ajax({
            url: "{{route('chatstore.shop')}}",
            method: 'POST',
            data: {
                _token: "{{ csrf_token() }}",
                users_id: iduser,
                isi_chat: $("#message").val(),
                sender: "seller"
            },
                ...
                $.each(response, function(i, k) {
                    if (k.sender == "user") {
                        $("#isiChat").append(
                            ...
                            '<span class="direct-chat-timestamp pull-right" >' + k.time + '</span>' + '</div>' +
                            '<img class="direct-chat-img" src="https://bootdey.com/img/Content/user_1.jpg" alt="Message User Image">' +
                            '<div class="direct-chat-text">' + k.isi_chat +
                            '</div>' +
                            '</div>'
                        );
                    } else {
                        $("#isiChat").append(
                            '<div class="direct-chat-msg right">' +
                            '<div class="direct-chat-info clearfix">' +
                            '<span class="direct-chat-name pull-right">' + k.shopname + '</span>' +
                            '<span class="direct-chat-timestamp pull-left" >' + k.time + '</span>' + '</div>' +
                            '<img class="direct-chat-img" src="https://bootdey.com/img/Content/user_1.jpg" alt="Message User Image">' +
                            '<div class="direct-chat-text">' + k.isi_chat +
                            '</div>' +
                            '</div>'

...
@section('content')
<h1 class="h3 mb-4 text-gray-800">Shop Registration</h1>
<form method="post" action="{{route('shop.store')}}">
    @csrf
    @method('post')
    <div class="form-group">
        <label>Shop Name</label>
        <input type="text" class="form-control" placeholder="Enter name" required name="shop_name">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="time" class="form-control" required name="open_hours">
    </div>
    <div class="form-group">
        <label>Close Hours</label>
        <input type="time" class="form-control" required name="close_hours">
    </div>
    <div class="form-group">
        <label>Phone</label>
        <input type="number" class="form-control" placeholder="Enter phone number" required name="phone">
    </div>
    <div class="form-group">
